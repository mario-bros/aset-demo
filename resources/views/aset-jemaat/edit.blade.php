...
$( document ).ready(function() {
    ...
    $('#add-atas-nama').click( function () {

        let $additionalInputElem = $('#atas-nama-additional');
        let $selectInputElem = $('#atas_nama_input');
        let $popUpModalElem = $('#m_modal_atas_nama');
        let urlRequest = "{{ url('aset-jemaat/add-atas-nama') }}";
        ...
        if (checkedStatusKepemilikanVal == "status_kepemilikan_hm") {
            ...
            if (checkedIDStatusKepemilikanHM == 1) {
                let $inputMasaBerlakuHM = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("status_kepemilikan_hm", @$aset_jemaat->status_kepemilikan_hm, ["class" => "form-control m-input m-input--square", "placeholder" => "Masa Berlaku HM"]) !!}' +
            ...
            if (checkedIDStatusKepemilikanHGB == 1) {
                let $inputMasaBerlakuHGB = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("status_kepemilikan_hgb", @$aset_jemaat->status_kepemilikan_hgb, ["class" => "form-control m-input m-input--square", "placeholder" => "Masa Berlaku HGB"]) !!}' +
            ...
            if (checkedIDStatusKepemilikanHP == 1) {
                let $inputMasaBerlakuHP = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("status_kepemilikan_hp", @$aset_jemaat->status_kepemilikan_hp, ["class" => "form-control m-input m-input--square", "placeholder" => "Masa Berlaku HP"]) !!}' +
            ...
            if (checkedIDStatusKepemilikanGirik == 1) {
                let $inputMasaBerlakuGirik = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("status_kepemilikan_girik", @$aset_jemaat->status_kepemilikan_girik, ["class" => "form-control m-input m-input--square", "placeholder" => "Masa Berlaku Girik"]) !!}' +
            ...
            if (checkedIDStatusKepemilikanLainLain == 1) {
                let $inputMasaBerlakuLainLain = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("status_kepemilikan_lain_lain", @$aset_jemaat->status_kepemilikan_lain_lain, ["class" => "form-control m-input m-input--square", "placeholder" => "Masa Berlaku Lain - Lain"]) !!}' +
    ...
    if ( $('input[type="radio"][name="atas_nama"]').is(':checked') ) {
        checkedAtasNamaJemaatVal = $('input[type="radio"][name="atas_nama"]:checked').val()
        ...
        if (checkedAtasNamaJemaatVal == "gpib_setempat") {
            ...
            if (checkedIDAtasNamaJemaat == 1) {
                let $inputAtasNamaJemaat = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("atas_nama_jemaat", @$aset_jemaat->extracted_atas_nama_jemaat, ["class" => "form-control m-input m-input--square", "placeholder" => "Atas Nama Jemaat"]) !!}' +
    ...
    if ( $('input[type="radio"][name="atas_nama"]').is(':checked') ) {
        checkedAtasNamaPribadiVal = $('input[type="radio"][name="atas_nama"]:checked').val()
        ...
        if (checkedAtasNamaPribadiVal == "pribadi") {
            ...
            if (checkedIDAtasNamaPribadi == 1) {
                let $inputAtasNamaPribadi = '<div class="form-group m-form__group">' +
                                                '{!! Form::label("atas_nama_prbadi", "Atas Nama Pribadi") !!}' +
                                                '{!! Form::text("atas_nama_prbadi", @$aset_jemaat->extracted_atas_nama_pribadi, ["class" => "form-control m-input m-input--square", "placeholder" => "Atas Nama Pribadi"]) !!}' +
                                                '{!! $errors->first("atas_nama_prbadi", "<p class=\'m--font-danger\'>:message</p>") !!}' +
                                            '</div>';
    ...
    if ( $('input[type="radio"][name="warna_status_kepemilikan_dokumen_imb"]').is(':checked') ) {
        ...
        if (checkedPunyaDokumenIMBVal == "00B050") {
            ...
            if (checkedIDPunyaDokumenIMB == 1) {
                let $inputPunyaDokumenIMB = '<div class="form-group m-form__group">' +
                                                ...
                                                '{!! Form::text("no_tgl_penerbitan_imb", @$aset_jemaat->no_tgl_penerbitan_imb, ["class" => "form-control m-input m-input--square", "placeholder" => "No Tanggal Penerbitan IMB"]) !!}' +
...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--tab">
        ...
        {!! Form::model($aset_jemaat, ['route' => ['aset-jemaat.update', $aset_jemaat], 'method' =>'put', 'role' => 'form', 'files' => true, 'class' => "m-form m-form--fit m-form--label-align-right"]) !!}
            @include('aset-jemaat._form', ['model' => $aset_jemaat])
        {!! Form::close() !!}
    </div>
    <!--end::Portlet-->
